...
pair_to_projects = {}
parameterssss = []
path = r'D:\PycharmProjects\Pars_project\pars_project_vfat\txt_files_vfat'
...
for net in all_nets_txt_files:
    ...
    for i in range(1, number_of_txt_files_in_net):
        ...
        database_helper.setdata_project_net_table(data_projects)
                ...
                if file_txt[j].split()[-2] == 'TVL:':
                    ...
                    for l in range(j, len(file_txt)):
                        ...
                        if file_txt[l] == '' or file_txt[l] == '\n':
                            ...
                            database_helper.setdata_main_table(pool_info)
                            break
